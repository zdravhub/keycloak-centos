...
CMD ["/opt/keycloak-1.9.1.Final/bin/standalone.sh","-c","/opt/keycloak-1.9.1.Final/standalone/configuration/standalone-full-ha.xml","-b","0.0.0.0","-bmanagement","0.0.0.0"]
